...
#skill p {
    ...
    <div class="container canvas_div_pdf" id="html-content-holder" style="width: 780px;border: 0px solid #000;">
        ...
        <div class="row" style="display: flex;align-items: stretch;">
            ...
            <div class="col-md-4" style="width: 30%;padding: 0;min-height: 800px;background: <?= $color4 ?>;">
                ...
                <div style="background: <?= $color4 ?>;padding-top: 40px;" class=" col-md-12">
    ...
    <div style="text-align: center;margin-top: 20px;" class="row">
        <a title="">Màu</a>
        <a href="index4.php?id=<?= $_GET['id'] ?>&color=1" title="" style="background: #FEE324;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px;"></a>
        <a href="index4.php?id=<?= $_GET['id'] ?>&color=2" title="" style="background: #7B7A78;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px;"></a>
        <a href="index4.php?id=<?= $_GET['id'] ?>&color=3" title="" style="background: #97CC88;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px;"></a>
        <a href="index4.php?id=<?= $_GET['id'] ?>&color=4" title="" style="background: #de5449;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index4.php?id=<?= $_GET['id'] ?>&color=5" title="" style="background: #2f5177;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
    </div>
<br/>
