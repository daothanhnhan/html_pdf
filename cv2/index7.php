...
#skill p {
    ...
    <div class="container canvas_div_pdf" id="html-content-holder" style="width: 820px;border: 1px solid #000;padding: 30px 40px 40px 40px;min-height: 1000px;background: #fff;">
        <div class="row" style="margin-left: 0;margin-right: 0;">
            ...
            <div class="col-md-5" style="padding-top: 20px;">
                <p>Họ và tên: <strong><?= $ung_vien['name'] ?></strong></p>
                <p>ĐT: <?= $ung_vien['phone'] ?></p>
        ...
        <div class="row" style="margin-left: 0;margin-right: 0;">
            <p style="background: <?= $color ?>;color:#fff;font-size: 17px;text-transform: uppercase;text-align: center;padding: 8px;margin-top: 5px;"><?= $ho_so['position'] ?></p>
        </div>
        <div class="row" style="margin-left: 0;margin-right: 0;">
            <div class="col-md-2" style="padding-left: 0;padding-right: 0;">
                <h2 style="margin: 0 5px;font-size: 16px;text-align: right;text-transform: uppercase;font-weight: bold;color: <?= $color ?>;">Thông tin hô sơ</h2>
            </div>
            <div class="col-md-10">
        ...
        <hr style="border-top: 2px solid <?= $color ?>;">
        <div class="row" style="margin-left: 0;margin-right: 0;">
            <div class="col-md-2" style="padding-left: 0;padding-right: 0;">
                <h2 style="margin: 0 5px;font-size: 16px;text-align: right;text-transform: uppercase;font-weight: bold;color: <?= $color ?>;">Mục tiêu nghề nghiệp</h2>
            </div>
            <div class="col-md-10">
                <?php
        ...
        <div class="row" style="margin-left: 0;margin-right: 0;">
            <div class="col-md-2" style="padding-left: 0;padding-right: 0;">
                <h2 style="margin: 0 5px;font-size: 16px;text-align: right;text-transform: uppercase;font-weight: bold;color: <?= $color ?>;">Kỹ năng<br> bản thân</h2>
            </div>
            <div class="col-md-10">
                <?php
        ...
        <div class="row" style="margin-left: 0;margin-right: 0;">
            <div class="col-md-2" style="padding-left: 0;padding-right: 0;">
                <h2 style="margin: 0 5px;font-size: 16px;text-align: right;text-transform: uppercase;font-weight: bold;color: <?= $color ?>;">Ngoại ngữ</h2>
            </div>
            <div class="col-md-10">
                <?php
        ...
        <div class="row" style="margin-left: 0;margin-right: 0;">
            <div class="col-md-2" style="padding-left: 0;padding-right: 0;">
                <h2 style="margin: 0 5px;font-size: 16px;text-align: right;text-transform: uppercase;font-weight: bold;color: <?= $color ?>;">Kinh nghiêm làm việc</h2>
            </div>
            <div class="col-md-10">
                <?php
        ...
        <hr style="border-top: 14px solid <?= $color ?>;">
    </div>
    <div style="text-align: center;margin-top: 20px;" class="row">
        <a title="">Màu</a>
        <a href="index7.php?id=<?= $_GET['id'] ?>&color=1" title="" style="background: #02B4E2;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index7.php?id=<?= $_GET['id'] ?>&color=2" title="" style="background: #2f5177;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index7.php?id=<?= $_GET['id'] ?>&color=3" title="" style="background: #de5449;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index7.php?id=<?= $_GET['id'] ?>&color=4" title="" style="background: #286898;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index7.php?id=<?= $_GET['id'] ?>&color=5" title="" style="background: #19a05e;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
    </div>
    <br/>
