...
#skill p {
    ...
    <div class="container canvas_div_pdf" id="html-content-holder" style="width: 780px;border: 1px solid #000;padding: 40px;background: #fff;">
        <div class="row">
            <div class="col-md-3">
                <div style="">
            ...
            <div class="col-md-9" style="margin-top: 11px;">
                <div class="row">
                    <div class="col-md-6">
                        <h1 style="color:<?= $color ?>;font-size: 24px;margin-bottom: 0;font-weight: bold;margin-top: 0;"><?= $ung_vien['name'] ?></h1>
        ...
        <hr style="border-top: 5px solid <?= $color ?>;">
        <h2 style="color: <?= $color ?>;text-transform: uppercase;font-size: 21px;font-weight: bold;">Thông tin hồ sơ</h2>
            <hr style="margin-top: 0;margin-bottom: 10px;border-top: 3px solid <?= $color ?>;">
            ...
            <h2 style="color: <?= $color ?>;text-transform: uppercase;font-size: 21px;font-weight: bold;">Mục tiêu nghề nghiệp</h2>
            <hr style="margin-top: 0;margin-bottom: 10px;border-top: 3px solid <?= $color ?>;">
            <p style="color: #000;">
                        <?php
            ...
            <h2 style="color: <?= $color ?>;text-transform: uppercase;font-size: 21px;font-weight: bold;">Kỹ năng của bản thân</h2>
            <hr style="margin-top: 0;margin-bottom: 10px;border-top: 3px solid <?= $color ?>;">
            <!-- <p>
                            <?php
            ...
            <h2 style="color: <?= $color ?>;text-transform: uppercase;font-size: 21px;font-weight: bold;">Ngoại ngữ</h2>
            <hr style="margin-top: 0;margin-bottom: 10px;border-top: 3px solid <?= $color ?>;">
            <p style="color: #000;">
                        <?php
            ...
            <h2 style="color: <?= $color ?>;text-transform: uppercase;font-size: 21px;font-weight: bold;">Kinh nghiệm làm việc</h2>
            <hr style="margin-top: 0;margin-bottom: 10px;border-top: 3px solid <?= $color ?>;">
            <p>
                            <?php
    ...
    <div style="text-align: center;margin-top: 20px;" class="row">
        <a title="">Màu</a>
        <a href="index6.php?id=<?= $_GET['id'] ?>&color=1" title="" style="background: #000;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index6.php?id=<?= $_GET['id'] ?>&color=2" title="" style="background: #2f5177;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index6.php?id=<?= $_GET['id'] ?>&color=3" title="" style="background: #de5449;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index6.php?id=<?= $_GET['id'] ?>&color=4" title="" style="background: #286898;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
        <a href="index6.php?id=<?= $_GET['id'] ?>&color=5" title="" style="background: #19a05e;color: #fff;padding: 3px 11px;border-radius: 15px;margin-left: 10px"></a>
    </div>
    <br/>
